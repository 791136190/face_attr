...
def do_utkface():
    ...
    root_path = "/home/hu/work/CV/dataset/utkface/"
    
    image_save_root = "/home/hu/work/CV/dataset/utkface/images/"
    if not os.path.exists(image_save_root):
        os.makedirs(image_save_root)

    fw = open("dataset/utkface_list.txt", 'w')
    ...
    label_list = ['part3/', 'part2/', 'part1/']
    for part in label_list:

        lines = get_all_list(root_path + part)
        for line in lines:
            line = line.strip()   # /home/hu/work/CV/dataset/utkface/part1/100_1_0_20170110183726390.jpg
            info = line.split('/')[-1].split('_') # ['100', '1', '0', '20170110183726390.jpg']

            cur_image_path = line # /home/hu/work/CV/dataset/utkface/part1/100_1_0_20170110183726390.jpg
            ...
            for box in face_boxs:
                ...
                gender = 0 # 1 -> fmale(女) 0 -> male(男) 我们需要的是 0 -> fmale(女) 1 -> male(男)
                if float(info[1]) < 1:
                    gender = 1
            ...
            if cur_index % 100 == 0:
                print("do utkface %d in %d" % (cur_index, len(lines)))
...
if __name__ == '__main__':
    ...
    print("end process utkface dataset !!!")